...
function initSearch() {
  ...
  request.open('GET', '/microhack-azure-migrate/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/microhack-azure-migrate/assets/css/just-the-docs-' + theme + '.css');
}
